...
const JobPost = () => {
    ...
    return (
        <div>
            <div>
                <section class="py-10 text-left bg-gradient-to-r from-fuchsia-600 to-blue-600 sm:py-16 lg:py-24">
                    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        <div class="max-w-2xl mx-auto text-center">
                            <h2 class="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">Post Your Job</h2>
                                ...
                                <div class="bg-gray-100 lg:col-span-2">
                                    <div class="h-full p-6 sm:p-10">
                                        <div class="flex flex-col justify-between h-full">
                                            <div>
                                                <h4 class="text-2xl font-semibold text-black">Contact With Us if you face any issue</h4>
